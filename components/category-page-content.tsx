...
interface CategoryPageContentProps {
  articles: Article[]
  sectorOrAll: Sector | 'all'
  sectorName: string
}

export default function CategoryPageContent({ articles, sectorOrAll, sectorName }: CategoryPageContentProps) {
  const { isCorp } = useStyle()

  if (isCorp && sectorOrAll !== 'all') {
