...
export const metadata: Metadata = {
  ...
  description: "AI-powered news analysis across 5 industry sectors. Get unbiased insights on how artificial intelligence is reshaping finance, healthcare, energy, and more.",
  metadataBase: new URL("https://nuaico.com"),
  openGraph: {
    type: "website",
    siteName: "Nuaico",
    title: "Nuaico - AI Sector News & Analysis",
    description: "AI-powered news analysis across 5 industry sectors.",
    locale: "en_US",
  },
  twitter: {
